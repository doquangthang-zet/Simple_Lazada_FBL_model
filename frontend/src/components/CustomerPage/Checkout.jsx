...
function Checkout() {
    ...
    function fecthcurrentOrder() {
        console.log(userId)
        axios.get('http://localhost:4000/getOneOrder/' + userId)
        .then((res) => {
                        ...
                        <form class="needs-validation" novalidate onSubmit={placeOrder}>
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" class="form-control" id="firstName" name="f_name" placeholder="Enter first name" value={order.f_name} onChange={handleChange} required />
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" class="form-control" id="lastName" name="l_name" placeholder="Enter last name" value={order.l_name} onChange={handleChange} required />
                                    <div class="invalid-feedback">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="email" class="form-control" id="email" name="email" value={order.email} onChange={handleChange} placeholder="you@example.com" />
                                <div class="invalid-feedback">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="address" name="address" value={order.address} onChange={handleChange} placeholder="1234 Main St" required />
                                <div class="invalid-feedback">
